...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { tax_name: @tax.tax_name, tax_percentage: @tax.tax_percentage } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { tax_name: @tax.tax_name, tax_percentage: @tax.tax_percentage } }
