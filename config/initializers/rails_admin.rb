RailsAdmin.config do |config|
  ...
  config.model 'Stock' do
    ...
    edit do
      include_fields :stock_sub_type, :title, :loose_total_caret, :loose_selection_carat, :loose_rejection_carat, :loose_rate_per_caret, :loose_total_amount, :loose_selected_amount, :loose_rejected_amount, :discount_percentage, :additional_disc_1, :additional_disc_2, :additional_disc_3, :carat, :amount, :weight, :rap, :state, :shape, :color, :clarity, :color_shades, :fancy_color, :color_intensity, :color_overtone, :flouresence, :lab, :cut, :polish, :symmetry, :black_table_inclusion, :black_crown_inclusion, :white_table_inclusion, :white_crown_inclusion, :milky_inclusion, :open_table_inclusion, :open_crown_inclusion, :open_pavilion_inclusion, :eye_clean_inclusion, :rough_origin, :heart_and_arrow, :max, :min, :hgt_height, :tbl_table, :td_percentage, :hAndA, :BIC, :BIS, :WIC, :col_tinge, :rapnet_id, :rapnet_dollar, :rapnet_discount_percentage, :rapnet_price_after_disc, :rapnet_amount_dollar_after_disc
    end
  end
